...
description: >
  Generate a full report of overall health across compliance, freshness, and
  consistency. Use when requesting a dashboard, config health check,
  maintenance status, or health score before major changes.
version: 1.0.0
